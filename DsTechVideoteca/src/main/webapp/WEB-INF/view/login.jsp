...
<body>
	...
	<form action="${loginUrl}" method="POST">
		<div class="group">
			<input type="text" name="ssoId"><span class="highlight"></span><span
				class="bar"></span> <label>User</label>
		</div>
		<div class="group">
			<input type="password" name="password"><span class="highlight"></span><span
	...
	<p>
		You Gotta Love <a href="http://www.dstech.it" target="_blank">DsTech</a>
	</p>
	</footer>
</body>
</html>